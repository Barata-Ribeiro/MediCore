...
'auth_pages.verify_email_page.form.logout','flash.exams.cbc.store_successfully','flash.exams.cbc.store_failed','flash.exams.cbc.update_unauthorized','flash.exams.cbc.update_successfully',
'flash.exams.cbc.update_failed','flash.exams.cbc.destroy_unauthorized','flash.exams.cbc.destroy_successfully','flash.exams.cbc.destroy_failed','flash.exams.glucose.store_successfully',
'flash.exams.glucose.store_failed','flash.exams.glucose.update_unauthorized','flash.exams.glucose.update_successfully','flash.exams.glucose.update_failed','flash.exams.glucose.destroy_unauthorized',
'flash.exams.glucose.destroy_successfully','flash.exams.glucose.destroy_failed','flash.exams.lipid_profile.store_successfully','flash.exams.lipid_profile.store_failed','flash.exams.lipid_profile.update_unauthorized',
'flash.exams.lipid_profile.update_successfully','flash.exams.lipid_profile.update_failed','flash.exams.lipid_profile.destroy_unauthorized','flash.exams.lipid_profile.destroy_successfully','flash.exams.lipid_profile.destroy_failed',
...
'main.settings_layout.title','main.settings_layout.description','pagination.previous','pagination.next','passwords.reset',
...
'validation.custom.attribute-name.rule-name','auth_pages.two_factor_challange_page.head_title','auth_pages.two_factor_challange_page.recovery.title','auth_pages.two_factor_challange_page.recovery.description','auth_pages.two_factor_challange_page.recovery.toggle_text',

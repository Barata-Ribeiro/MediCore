...
'C:.Users.jmend.Herd.MediCore.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.custom.attribute-name.rule-name','auth.failed','auth.password','auth.throttle','flash.exams.cbc.store_successfully',
...
'validation.ulid','validation.uuid','validation.custom.attribute-name.rule-name','passwords.password','validation.attributes.address',

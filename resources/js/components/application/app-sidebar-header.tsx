...
export function AppSidebarHeader({ breadcrumbs = [] }: Readonly<{ breadcrumbs?: BreadcrumbItemType[] }>) {
    return (
        <header className="transition-size flex h-16 shrink-0 items-center gap-2 border-b border-sidebar-border/50 px-6 ease-linear group-has-data-[collapsible=icon]/sidebar-wrapper:h-12 md:px-4">

...
export default function LipidProfileChart({ chartData, total }: Readonly<Props>) {
    const { __ } = lang();
    ...
    return (
        <Card className="mx-auto max-w-3xl">
            <CardHeader>
                <CardTitle>{__('lipid_profile_pages.index.chart.title')}</CardTitle>
                <CardDescription>{__('lipid_profile_pages.index.chart.description')}</CardDescription>
            </CardHeader>
            <CardContent>

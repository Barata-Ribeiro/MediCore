...
export default function TotalProteinsAndFractionsChart({ chartData, total }: Readonly<Props>) {
    const { __ } = lang();
    ...
    return (
        <Card className="mx-auto max-w-3xl">
            <CardHeader>
                <CardTitle>{__('total_proteins_and_fractions_pages.index.chart.title')}</CardTitle>
                <CardDescription>{__('total_proteins_and_fractions_pages.index.chart.description')}</CardDescription>
            </CardHeader>
            <CardContent>

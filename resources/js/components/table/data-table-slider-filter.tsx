...
export function DataTableSliderFilter<TData>({ column, title }: Readonly<DataTableSliderFilterProps<TData>>) {
    ...
    const { min, max, step } = React.useMemo<Range & { step: number }>(() => {
        ...
        const calculatedStep = rangeSize <= 100 ? Math.ceil(rangeSize / 20) : Math.ceil(rangeSize / 50);
        const step = rangeSize <= 20 ? 1 : calculatedStep;

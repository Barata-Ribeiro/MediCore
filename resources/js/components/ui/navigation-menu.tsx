...
function NavigationMenuTrigger({ className, children, ...props }: Readonly<NavigationMenuPrimitive.Trigger.Props>) {
    return (
...
function NavigationMenuContent({ className, ...props }: Readonly<NavigationMenuPrimitive.Content.Props>) {
    return (

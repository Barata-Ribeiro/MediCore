...
function AccordionTrigger({ className, children, ...props }: Readonly<AccordionPrimitive.Trigger.Props>) {
    return (
...
function AccordionContent({ className, children, ...props }: Readonly<AccordionPrimitive.Panel.Props>) {
    return (

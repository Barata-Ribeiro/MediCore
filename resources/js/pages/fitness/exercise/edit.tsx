...
export default function EditExercise({ exercise, muscleGroups }: Readonly<Props>) {
    const { __ } = lang();
        ...
        <Modal>
            {({ close }: Readonly<CloseActionType>) => (
                <Fragment>
                    ...
                    <CardContent>
                        <ExerciseRegistryForm exercise={exercise} muscleGroups={muscleGroups} closeAction={close} />
                    </CardContent>
                </Fragment>
            )}
        </Modal>

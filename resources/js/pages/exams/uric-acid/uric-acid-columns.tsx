...
export const columns: ColumnDef<UricAcid>[] = [
    {
        accessorKey: 'id',
    ...
    },
    {
        ...
        header: ({ column }) => <DataTableColumnHeader column={column} title="Uric Acid" />,
        cell: ({ row }) => `${row.original.uric_acid_level} mg/dL`,
        enableSorting: true,
    },
    {
    ...
    },
    {
        ...
        cell: function Cell({ row }) {
            ...
            const valuesToCopy = `Report Date: ${format(row.original.report_date, 'PPP')}, Uric Acid: ${row.original.uric_acid_level} mg/dL, Created At: ${format(row.original.created_at, 'PPP p')}`;

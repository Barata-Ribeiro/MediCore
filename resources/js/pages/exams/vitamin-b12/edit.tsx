...
export default function Edit({ vitaminB12 }: Readonly<Props>) {
    setLayoutProps({
        ...
        breadcrumbs: [
            ...
            { title: 'Edit', href: edit(vitaminB12.id) },
        ],
    });

    return (
        <Fragment>
            <Head title="Edit Vitamin B12 record" />
            <h1 className="sr-only">Edit Vitamin B12 record</h1>
            ...
            <Card className="mx-auto w-full flex-col space-y-4">
                ...
                <CardFooter>
                    <p className="text-sm text-muted-foreground">
                        By editing a Vitamin B12 record, you can update your vitamin B12 levels over time and gain

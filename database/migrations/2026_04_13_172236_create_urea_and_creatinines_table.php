...
return new class extends Migration
{
    ...
    {
        Schema::create('urea_and_creatinines', function (Blueprint $table) {
            $table->id();
            $table->double('urea_level')->comment('Urea level');
            $table->double('creatinine_level')->comment('Creatinine level');
    ...
    {
        Schema::dropIfExists('urea_and_creatinines');
    }
};

...
test('application translation keys resolve from standard language files', function () {
    ...
    expect($translator)
        ...
        ->and($translator->get('auth_pages.login_page.form.passkey_button', [], 'en'))
        ->toBe('Sign in with passkey')
        ->and($translator->get('settings_pages.profile_page.delete_account_section.title', [], 'en'))
        ->toBe('Delete account')
        ->and($translator->get('settings_pages.security_page.passkeys_section.title', [], 'en'))
        ->toBe('Passkeys')
        ...
        ->toBe('Glucose Exams')
        ->and($translator->get('ultrasensitive_tsh_pages.index.head_title', [], 'en'))
        ->toBe('Ultrasensitive TSH Exams')
        ...
        ->toBe('Entrar com chave de acesso')
        ->and($translator->get('settings_pages.profile_page.delete_account_section.title', [], 'pt_BR'))
        ->toBe('Excluir conta')
        ->and($translator->get('settings_pages.security_page.passkeys_section.title', [], 'pt_BR'))
        ->toBe('Chaves de acesso')
        ->and($translator->get('glucose_pages.index.head_title', [], 'pt_BR'))
        ->toBe('Exames de Glicose')
        ->and($translator->get('ultrasensitive_tsh_pages.index.head_title', [], 'pt_BR'))
        ->toBe('Exames de TSH Ultrassensível')
